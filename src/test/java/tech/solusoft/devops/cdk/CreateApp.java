...
public class CreateApp {
    ...
    public void createApp() {
        ...
        new AbstractStack(app, "microlam-java17-demo", 
			...
			protected void init(Construct scope, String id, StackProps props) {
				...
				int version = 17; //Java version = 11 or 17 or 19 or 8
				...
				Function.Builder handlerBuilder = Function.Builder.create(this, "MicrolamJava17Demo")			    		  
			    ...
			    //Code
			    if (java) {
			    	handlerBuilder.code(Code.fromAsset("target/microlam-java17-demo-1.0-SNAPSHOT-aws-lambda.zip"));
			    }
			    else { //Native
			    	handlerBuilder.code(Code.fromAsset("target/microlam-java17-demo-1.0-SNAPSHOT-aws-lambda-native.zip"));			    	
			    }
		        ...
		        RestApi api = RestApi.Builder.create(this, "microlam-java17-demo-api")
		                .restApiName("microlam-java17-demo").description("MicrolamJava17Demo API.")
